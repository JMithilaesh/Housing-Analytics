...
# "mongoUrl": "mongodb://localhost:27017/Zillow"new server mongo URI

class mongo:
    # def __init__(self):
    #     self.client = MongoClient('129.174.126.176', 27018)
    #     db = self.client['Zillow']  # NAME OF DATABASE
    #     self.collection = db['Test']  # NAME OF COLLECTION
...
#     collection = db['Test']  # NAME OF COLLECTION
#     print("MongoDB connected...")
#     return collection
...
# previously commented before Jan 18 2021
# self.client = MongoClient('129.174.126.176', 27018)
#         db = self.client['Zillow']  # NAME OF DATABASE
