...
Region1 = ['Accomack', 'Isle of Wight', 'Northampton', 'Prince George', 'Southampton', 'Surry', 'Sussex',
           ...
           'Northumberland', 'Richmond', 'Westmoreland', 'York']
Region2 = ['Arlington', 'Fairfax', 'Loudoun', 'Prince William']
...
Region4 = ['Clarke', 'Frederick', 'Greene', 'Madison', 'Page', 'Shenandoah', 'Warren']

Region5 = ['Alleghany', 'Amherst', 'Augusta', 'Bath', 'Highland', 'Rockbridge', 'Rockingham',
           'Appomattox', 'Campbell', 'Floyd', 'Franklin', 'Halifax', 'Henry', 'Mongomery', 'Patrick', 'Pittsylvania',
           'Bedford', 'Botetourt', 'Craig', 'Giles', 'Roanoke',
           'Bland', 'Carroll', 'Grayson', 'Pulaski', 'Smyth', 'Washington', 'Wythe',
