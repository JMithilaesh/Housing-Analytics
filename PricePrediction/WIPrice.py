...
# Regions from: https://www.dhs.wisconsin.gov/aboutdhs/regions.htm

Region1 = ['Adams', 'Columbia', 'Crawford', 'Dane', 'Dodge', 'Grant', 'Green', 'Iowa', 'Juneau', 'Lafayette', 'Richland', 'Rock', 'Sauk', 'Vernon']
Region2 = ['Jefferson', 'Kenosha', 'Milwaukee', 'Ozaukee', 'Racine', 'Walworth', 'Washington', 'Waukesha']
Region3 = ['Brown', 'Calumet', 'Door', 'Fond du Lac', 'Green Lake', 'Kewaunee', 'Manitowoc', 'Marinette', 'Marquette', 'Menominee', 'Oconto', 'Outagamie', 'Shawano', 'Sheboygan', 'Waupaca', 'Waushara', 'Winnebago']
Region4 = ['Barron', 'Buffalo', 'Burnett', 'Chippewa', 'Clark', 'Douglas', 'Dunn', 'Eau Claire', 'Jackson', 'La Crosse', 'Monroe', 'Pepin', 'Pierce', 'Polk', 'Rusk', 'St. Croix', 'Trempealeau', 'Washburn']
Region5 = ['Ashland', 'Bayfield', 'Florence', 'Forest', 'Iron', 'Langlade', 'Lincoln', 'Marathon', 'Oneida', 'Portage', 'Price', 'Sawyer', 'Taylor', 'Vilas', 'Wood']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'WI', "county_name": {"$in": i}})
