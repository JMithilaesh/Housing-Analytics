...
# Regions from: https://www.deq.idaho.gov/regional-offices-issues/

Region1 = ['Benewah', 'Bonner', 'Boundary', 'Kootenai', 'Shoshone',
           'Ada', 'Adams', 'Boise', 'Canyon', 'Elmore', 'Gem', 'Owyhee', 'Payette', 'Valley', 'Washington']
Region3 = ['Bonneville', 'Butte', 'Clark', 'Custer', 'Fremont', 'Jefferson', 'Lemhi', 'Madison', 'Teton']
Region4 = ['Clearwater', 'Idaho', 'Latah', 'Lewis', 'Nez Perce', 'Bingham', 'Power', 'Bannock', 'Caribou', 'Franklin', 'Bear Lake']
Region6 = [
    "Blaine",
    "Bonneville",
    "Camas",
...
Region = [Region1, Region3, Region4, Region6]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'ID', "county_name": {"$in": i}})
