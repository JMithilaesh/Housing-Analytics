...
# Regions from: https://osdaohio.org/find-my-region/#1486482479620-9d190466-6e0a
Region1 = ['Allen', 'Crawford', 'Defiance', 'Erie', 'Fulton', 'Hancock', 'Hardin', 'Henry', 'Huron', 'Lucas', 'Morrow',
           'Ottawa', 'Paulding', 'Putman', 'Sandusky', 'Seneca', 'Williams', 'Wood', 'Wyandot', 'Marion', 'Van Wert',
           'Ashland', 'Ashtabula', 'Columbiana', 'Cuyahoga', 'Geauga', 'Lake', 'Lorain', 'Mahoning', 'Medina',
           'Portage', 'Richland', 'Stark', 'Summit', 'Trumbull', 'Wayne']
Region2 = ['Adams', 'Auglaize', 'Brown', 'Butler', 'Champain', 'Clark', 'Clermont', 'Clinton', 'Drake', 'Fayette',
           'Greene', 'Hamilton', 'Highland', 'Logan', 'Mercer', 'Miami', 'Montgomery', 'Preble', 'Shelby', 'Warren']
Region3 = ['Athens', 'Belmont', 'Carroll', 'Coshocton', 'Guernsey', 'Harrison', 'Hocking', 'Holmes', 'Jackson',
           'Jefferson', 'Knox', 'Lawerence', 'Meigs', 'Monroe', 'Morgan', 'Muskingum', 'Noble', 'Perry', 'Pickaway',
           'Pike', 'Ross', 'Scioto', 'Tuscarawas', 'Vinton', 'Washington',
           'Delaware', 'Fairfield', 'Franklin', 'Licking', ' Madison', 'Union']

Region = [Region1, Region2, Region3]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'OH', "county_name": {"$in": i}})
