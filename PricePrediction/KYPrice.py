...
# Regions from: https://www.uky.edu/Libraries/NDNP/regions.html

Region1 = ['Bell', 'Breathitt', 'Boyd', 'Carter', 'Clay', 'Elliott', 'Floyd', 'Greenup', 'Harlan', 'Jackson', 'Johnson', 'Knott', 'Knox', 'Laurel', 'Lawrence', 'Lee', 'Leslie', 'Letcher', 'Magoffin', 'Martin', 'McCreary', 'Menifee', 'Montgomery', 'Morgan', 'Owsley', 'Perry', 'Pike', 'Powell', 'Rowan', 'Whitley', 'Wolfe',
           'Anderson', 'Bath', 'Boone', 'Bourbon', 'Boyle', 'Bracken', 'Campbell', 'Carroll', 'Clark', 'Fayette', 'Fleming', 'Franklin', 'Gallatin', 'Grant', 'Henry', 'Harrison', 'Jefferson', 'Jessamine', 'Kenton', 'Lewis', 'Mason', 'Mercer', 'Nicholas', 'Oldham', 'Owen', 'Pendleton', 'Robertson', 'Scott', 'Shelby', 'Spencer', 'Trimble', 'Washington', 'Woodford']
Region3 = ['Bullitt', 'Estill', 'Garrard', 'Lincoln', 'Madison', 'Marion', 'Nelson', 'Rockcastle']
Region4 = ['Adair', 'Allen', 'Barren', 'Breckinridge', 'Caldwell', 'Casey', 'Christian', 'Clinton', 'Crittenden', 'Cumberland', 'Green', 'Hardin', 'Hart', 'Hopkins', 'Larue', 'Livingston', 'Logan', 'Lyon', 'Meade', 'Metcalfe', 'Monroe', 'Pulaski', 'Russell', 'Simpson', 'Taylor', 'Todd', 'Trigg', 'Warren', 'Wayne']
Region5 = ['Ballard', 'Calloway', 'Carlisle', 'Fulton', 'Graves', 'Hickman', 'Marshall', 'McCracken',
           'Butler', 'Daviess', 'Edmonson', 'Grayson', 'Hancock', 'Henderson', 'McLean', 'Muhlenberg', 'Ohio', 'Union', 'Webster']


Region = [Region1, Region3, Region4, Region5]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'KY', "county_name": {"$in": i}})
