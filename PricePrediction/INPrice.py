...
# Regions from: http://www.stats.indiana.edu/maptools/boundary.asp

Region1 = ["Lake", "Porter","LaPorte", "St. Joseph", "Elkhart", "Lagrange", "Steuben", "Newton", "Jasper", "Starke", "Marshall", "Kosciusko", "Noble", "DeKalb", "Pulaski", "Fulton", "Whitley", "Allen",
           "Benton", "White", "Cass", "Miami", "Wabasha", "Huntington", "Wells", "Adams", "Carroll", "Howard", "Grant", "Blackford", "Jay"]
Region2 = ["Warren", "Fountain", "Tippecanoe", "Clinton", "Tipton", "Madison", "Delaware", "Randolph", "Vermillion",
           "Montgomery", "Boone", "Hamilton", "Henry", "Wayne", "Parke", "Putnam", "Hendricks", "Marion", "Hancock",
           "Vigo", "Clay", "Morgan", "Johnson", "Shelby", "Rush", "Fayette", "Union", "Owen", "Monroe", "Brown", "Bartholomew",
           "Decatur", "Franklin"]
Region3 = ["Knox", "Daviess", "Martin", "Lawrence", "Jackson", "Jennings", "Ripley", "Dearborn", "Gibson", "Pike", "Dubois", "Orange",
           "Washington", "Scott", "Jefferson", "Switzerland", "Crawford", "Clark", "Posey", "Vanderburgh", "Warrick", "Spencer", "Perry", "Harrison", "Floyd"
          ]
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'IN', "county_name": {"$in": i}})
