...
# Regions from: https://www.homelandsecurity.iowa.gov/county_em/county_em_overview.html

Region1 = ['Boone', 'Calhoun', 'Carroll', 'Dallas', 'Greene', 'Grundy', 'Hamilton', 'Hardin', 'Jasper', 'Marshall', 'Polk', 'Poweshiek', 'Story', 'Tama', 'Warren', 'Webster']
Region2 = ['Allamakee', 'Bremer', 'Butler', 'Cerro Gordo', 'Chickasaw', 'Emmet', 'Fayette', 'Floyd', 'Franklin', 'Hancock', 'Howard', 'Humboldt', 'Kossuth', 'Mitchell', 'Winnebago', 'Winneshiek', 'Worth', 'Wright']
Region3 = ['Buena Vista', 'Cherokee', 'Clay', 'Crawford', 'Dickinson', 'Ida', 'Lyon', 'Monona', "O'Brien", 'Osceola', 'Palo Alto', 'Plymouth', 'Pocahontas', 'Sac', 'Sioux', 'Woodbury']
Region4 = ['Adair', 'Adams', 'Audubon', 'Cass', 'Clarke', 'Decatur', 'Fremont', 'Guthrie', 'Harrison', 'Madison', 'Mills', 'Montgomery', 'Page', 'Pottawattamie', 'Ringgold', 'Shelby', 'Taylor', 'Union']
Region5 = ['Appanoose', 'Davis', 'Des Moines', 'Henry', 'Jefferson', 'Keokuk', 'Lee', 'Louisa', 'Lucas', 'Mahaska', 'Marion', 'Monroe', 'Muscatine', 'Van Buren', 'Wapello', 'Washington', 'Wayne']
Region6 = ['Benton', 'Black Hawk', 'Buchanan', 'Cedar', 'Clayton', 'Clinton', 'Delaware', 'Dubuque', 'Iowa', 'Jackson', 'Johnson', 'Jones', 'Linn', 'Scott']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'IA', "county_name": {"$in": i}})
