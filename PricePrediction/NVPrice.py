...
# Regions from: https://nevada.reaproject.org/img/maps/Nevada_EDA_Regions_Full.png

Region1 = ['Washoe', 'Pershing', 'Storey', 'Churchill', 'Lyon', 'Carson City', 'Mineral', 'Douglas']
Region2 = ['Humboldt', 'Elko', 'Lander', 'Eureka', 'White Pine']
Region3 = ['Esmeralda', 'Nye', 'Lincoln', 'Clark']

Region = [Region1, Region2, Region3]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'NV', "county_name": {"$in": i}})
