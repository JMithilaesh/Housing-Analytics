...
# Regions from: https://www.hydesmith.senate.gov/regions

Region1 = ['Hinds', 'Rankin', 'Madison', 'Copiah', 'Simpson', 'Warren']
Region2 = ['Hancock', 'Harrison', 'Jackson', 'Pearl River', 'Stone', 'George']
Region3 = ['Attala', 'Bolivar', 'Carroll', 'Coahoma', 'DeSoto', 'Grenada', 'Holmes', 'Humphreys', 'Issaquena', 'Leflore', 'Montgomery', 'Panola', 'Quitman', 'Sharkey', 'Sunflower', 'Tallahatchie', 'Tate', 'Tunica', 'Washington', 'Yalobusha', 'Yazoo']
Region4 = ['Leake', 'Neshoba', 'Kemper', 'Scott', 'Newton', 'Lauderdale', 'Smith', 'Jasper', 'Clarke']
Region5 = ['Oktibbeha', 'Lowndes', 'Clay', 'Webster', 'Choctaw', 'Winston', 'Noxubee']
Region6 = ['Lee', 'Lafayette', 'Pontotoc', 'Monroe', 'Itawamba', 'Tishomingo', 'Prentiss', 'Alcorn', 'Tippah', 'Union', 'Benton', 'Marshall', 'Calhoon', 'Chickasaw']
Region7 = ['Forrest', 'Covington', 'Jones', 'Wayne', 'Jefferson Davis', 'Marion', 'Lamar', 'Perry', 'Greene']
Region8 = ['Adams', 'Lincoln', 'Lawrence', 'Franklin', 'Claiborne', 'Jefferson', 'Wilkinson', 'Amite', 'Pike', 'Walthall']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'MS', "county_name": {"$in": i}})
