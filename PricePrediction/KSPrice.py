...
# Regions from: https://ksso.org/ksregions/

Region1 = ['Barton', 'Cheyenne', 'Clark', 'Decatur', 'Edwards', 'Ellis', 'Finney', 'Ford', 'Gove', 'Graham', 'Grant', 'Gray', 'Greeley', 'Hamilton', 'Haskell', 'Hodgeman', 'Kearny', 'Lane', 'Logan', 'Meade', 'Morton', 'Ness', 'Norton', 'Osborne', 'Pawnee', 'Phillips', 'Rawlins', 'Rooks', 'Rush', 'Russell', 'Scott', 'Seward', 'Sheridan', 'Sherman', 'Smith', 'Stanton', 'Stevens', 'Thomas', 'Trego', 'Wallace', 'Wichita']
Region2 = ['Brown', 'Clay', 'Cloud', 'Dickinson', 'Ellsworth', 'Geary', 'Jackson', 'Jewell', 'Lincoln', 'Marion', 'Marshall', 'McPherson', 'Mitchell', 'Morris', 'Nemaha', 'Ottawa', 'Pottawatomie', 'Republic', 'Rice', 'Riley', 'Saline', 'Shawnee', 'Wabaunsee', 'Washington']
Region3 = ['Barber', 'Butler', 'Chase', 'Comanche', 'Cowley', 'Harper', 'Harvey', 'Kingman', 'Kiowa', 'Lyon', 'Pratt', 'Reno', 'Sedgwick', 'Stafford', 'Sumner']
Region4 = ['Allen', 'Bourbon', 'Chautauqua', 'Cherokee', 'Crawford', 'Elk', 'Greenwood', 'Labette', 'Montgomery', 'Neosho', 'Wilson', 'Woodson']
Region5 = ['Anderson', 'Atchison', 'Coffey', 'Doniphan', 'Douglas', 'Franklin', 'Jefferson', 'Johnson', 'Leavenworth', 'Linn', 'Miami', 'Osage', 'Wyandotte']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'KS', "county_name": {"$in": i}})
