...
# Regions from: https://www.malph.org/state-michigan-health-assessment

Region1 = ['Clinton', 'Eaton', 'Gratiot', 'Hillsdale', 'Ingham', 'Jackson', 'Lenawee', 'Livingston', 'Shiawassee']
Region2 = ['Macomb', 'Oakland', 'St. Clair', 'Monroe', 'Washtenaw', 'Wayne']
Region3 = ['Alcona', 'Arenac', 'Bay', 'Genesee', 'Gladwin', 'Huron', 'Iosco', 'Lapeer', 'Midland', 'Ogemaw', 'Oscoda', 'Saginaw', 'Sanilac', 'Tuscola']
Region4 = ['Allegan', 'Barry', 'Berrien', 'Branch', 'Calhoun', 'Cass', 'Kalamazoo', 'St. Joseph', 'VanBuren']
Region5 = ['Clare', 'Ionia', 'Isabella', 'Kent', 'Lake', 'Mason', 'Mecosta', 'Montcalm', 'Muskegon', 'Newaygo', 'Oceana', 'Osceola', 'Ottawa']
Region6 = ['Alpena', 'Antrim', 'Benzie', 'Charlevoix', 'Cheboygan', 'Crawford', 'Emmet', 'Grand Traverse', 'Kalkaska', 'Leelanau', 'Manistee', 'Missaukee', 'Montmorency', 'Otsego', 'Presque Isle', 'Roscommon', 'Wexford']
Region7 = ['Alger', 'Baraga', 'Chippewa', 'Delta', 'Dickinson', 'Gogebic', 'Houghton', 'Iron', 'Keweenaw', 'Luce', 'Mackinac', 'Marquette', 'Menominee', 'Ontonagon', 'Schoolcraft']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'MI', "county_name": {"$in": i}})
