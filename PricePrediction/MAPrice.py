...
# Regions from: https://massgaming.com/about/expanded-gaming-act/

Region1 = ['Suffolk', 'Middlesex', 'Essex', 'Norfolk', 'Worcester']
Region2 = ['Hampshire', 'Hampden', 'Franklin', 'Berkshire']
Region3 = ['Bristol', 'Plymouth', 'Nantucket', 'Dukes', 'Barnstable']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'MA', "county_name": {"$in": i}})
