...
# Regions from: https://epi.dph.ncdhhs.gov/phpr/regions.html
#or https://www.ncae.org/who-we-are/state-regional-map/

Region1 = ['Alamance', 'Caswell', 'Chatham', 'Davidson', 'Davie', 'Durham', 'Edgecombe', 'Forsyth', 'Franklin', 'Granville', 'Guilford', 'Halifax', 'Harnett', 'Johnston', 'Lee', 'Moore', 'Montgomery', 'Nash', 'Northampton', 'Orange', 'Person', 'Randolph', 'Richmond', 'Rockingham', 'Scotland', 'Stokes', 'Surry', 'Vance', 'Wake', 'Warren', 'Wilson', 'Yadkin']
Region2 = ['Anson', 'Cabarrus', 'Catawba', 'Cleveland', 'Gaston', 'Iredell', 'Lincoln', 'Mecklenburg', 'Rowan', 'Stanly', 'Union']
Region3 = ['Beaufort', 'Bertie', 'Bladen', 'Brunswick', 'Camden', 'Carteret', 'Chowan', 'Columbus', 'Craven', 'Cumberland', 'Currituck', 'Dare', 'Duplin', 'Gates', 'Greene', 'Hertford', 'Hoke', 'Hyde', 'Jones', 'Lenoir', 'Martin', 'New Hanover', 'Onslow', 'Pamlico', 'Pasquotank', 'Pender', 'Perquimans', 'Pitt', 'Robeson', 'Sampson', 'Tyrrell', 'Washington', 'Wayne']
Region4 = ['Alexander', 'Alleghany', 'Ashe', 'Avery', 'Buncombe', 'Burke', 'Caldwell', 'Cherokee', 'Clay', 'Graham', 'Haywood', 'Henderson', 'Jackson', 'Macon', 'Madison', 'McDowell', 'Mitchell', 'Polk', 'Rutherford', 'Swain', 'Transylvania', 'Watauga', 'Wilkes', 'Yancey']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'NC', "county_name": {"$in": i}})
