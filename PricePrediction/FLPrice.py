...
# Regions from: http://fpan.us/regions.php

Region1 = ['Bay', 'Calhoun', 'Escambia', 'Gulf', 'Holmes', 'Jackson', 'Okaloosa', 'Santa Rosa', 'Walton', 'Washington']
Region2 = ['Baker', 'Columbia', 'Dixie', 'Franklin', 'Gadsden', 'Hamilton', 'Jefferson', 'Lafayette', 'Leon', 'Liberty', 'Madison', 'Suwannee', 'Taylor', 'Union', 'Wakulla']
Region3 = ['Clay', 'Duval', 'Flagler', 'Nassau', 'Putnam', "St. Johns", 'Volusia']
Region4 = ['Brevard', 'Indian', 'River', 'Martin', 'Okeechobee', 'Orange', 'Osceola', 'Seminole', "St. Lucie"]
Region5 = ['Alachua', 'Bradford', 'Citrus', 'Gilchrist', 'Hernando', 'Lake', 'Levy', 'Marion', 'Sumter']
Region6 = ['Desoto', 'Hardee', 'Highlands', 'Hillsborough', 'Manatee', 'Pasco', 'Pinellas', 'Polk', 'Sarasota']
Region7 = ['Charlotte', 'Collier', 'Glades', 'Hendry', 'Lee']
Region8 = ['Broward', 'Miami-Dade', 'Monroe', 'Palm Beach']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'FL', "county_name": {"$in": i}})
