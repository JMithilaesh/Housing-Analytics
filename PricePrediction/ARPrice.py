...
# Regions from: https://www.arkansas-catholic.org/news/article/1591/Pastoral-planning-to-begin-in-parishes-soon

Region1 = ['Pulaski', 'Grant', 'Faulkner', 'Cle burne', 'White', 'Lonoke', 'Saline', 'Hot Spring', 'Gar land']

Region2 = ['Randolph', 'Clay', 'Lawrence', 'Greene', 'Craighead', 'Mississippi', 'Phillips', 'Poinsett', 'Jackson', 'Woodruff', 'Cross', 'Crittenden', "St. Francis", 'Lee', 'Monroe']

Region3 = ['Carroll', 'Boone', 'Newton', 'Marion', 'Searcy', 'Baxter', 'Stone', 'Izard', 'Fulton', 'Sharp', 'Independence']

Region4 = ['Polk', 'Montgomery', 'Sevier', 'Howard', 'Pike', 'Clark', 'Dallas', 'Calhoun', 'Ouachita', 'Nevada', 'Hempstead', 'Little River', 'Miller', 'Lafayette', 'Columbia', 'Union']

Region5 = ['Chicot', 'Ashley', 'Bradley', 'Drew', 'Desha', 'Lincoln', 'Cleveland', 'Arkansas', 'Jefferson', 'Prairie']

Region6 = ['Franklin', 'Johnson', 'Logan', 'Yell', 'Pope', 'Van Buren', 'Conway', 'Perry']

Region7 = ['Benton', 'Washington', 'Madison', 'Crawford', 'Sebastian', 'Scott']

Region = [Region1, Region2, Region3, Region4, Region5, Region6, Region7]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'AR', "county_name": {"$in": i}})
