...
# Regions from: https://www.dnr.wa.gov/about/dnr-regions-and-districts

Region1 = ['Clallam', 'Jefferson', 'Grays Harbor']
Region2 = ['Lewis', 'Pacific', 'Wahkiakum', 'Cowlitz', 'Clark', 'Skamania']
Region3 = ['King', 'Pierce', 'Kitsap', 'Mason', 'Thurston', 'Snohomish']
Region4 = ['Adams', 'Asotin', 'Benton', 'Chelan', 'Columbia', 'Douglas', 'Franklin', 'Garfield', 'Grant', 'Kittitas', 'Klickitat', 'Lincoln', 'Walla Walla', 'Whitman', 'Yakima']
Region5 = ['Okanogan', 'Ferry', 'Stevens', 'Pend Oreille', 'Spokane']
Region6 = ['Island', 'San Juan', 'Skagit', 'Snohomish', 'Whatcom']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'WA', "county_name": {"$in": i}})
