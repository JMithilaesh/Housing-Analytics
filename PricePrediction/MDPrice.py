...
# Regions from: https://www.visitmaryland.org/info/maryland-regions
Region1 = ['Frederick', 'Montgomery', 'Prince George\'s']

Region2 = ['Anne Arundel', 'Baltimore', 'Carroll', 'Harford', 'Howard']

Region3 = ['Calvert', 'Charles', 'St. Mary\'s']

Region4 = ['Kent', 'Queen Anne\'s', 'Talbot', 'Caroline', 'Dorchester', 'Wicomico', 'Somerset', 'Worcester', 'Cecil ']

Region5 = ['Garrett', 'Allegany', 'Washington']

Region = [Region1, Region2, Region3, Region4, Region5]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'MD', "county_name": {"$in": i}})
