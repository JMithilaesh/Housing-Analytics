...
# Regions from: https://www.pinterest.com/pin/205969382935586763/

Region1 = ['Warren', 'Sussex', 'Passaic', 'Bergen', 'Morris', 'Essex', 'Hudson']
Region2 = ['Hunterdon', 'Somerest', 'Union', 'Mercer', 'Middlesex']
Region3 = ['Monmouth', 'Ocean', 'Atlantic', 'Cape May']
Region4 = ['Burlington', 'Camden', "Gloucester", 'Salem', "Cumberland"]
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'NJ', "county_name": {"$in": i}})
