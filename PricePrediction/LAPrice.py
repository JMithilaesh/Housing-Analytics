...
# Regions from: https://www.deep-south-usa.com/louisiana/regions-of-louisiana

Region1 = ['Jefferson', 'Orleans', 'St. Bernard', 'St. Tammany', 'St. Charles', 'St. John the Baptist', 'Tangipahoa']
Region2 = ['Acadia', 'Ascension', 'Assumption', 'Avoyelles', 'Calcasieu', 'Cameron', 'Evangeline', 'Iberia', 'Iberville', 'Jefferson Davis', 'Lafayette', 'Lafourche', 'Pointe Coupee', 'St. James', 'St. Landry', 'St. Martin', 'St. Mary', 'Terrebonne', 'Vermilion', 'West Baton Rouge']
Region3 = ['East Baton Rouge', 'East Feliciana', 'Livingston', 'St. Helena', 'Washington', 'West Feliciana']
Region4 = ['Bienville', 'Bossier', 'Caddo', 'Caldwell', 'Claiborne', 'East Carroll', 'Franklin', 'Jackson', 'Lincoln', 'Madison', 'Morehouse', 'Ouachita', 'Red River', 'Richland', 'Tensas', 'Union', 'Webster', 'West Carroll', 'Winn']
Region5 = ['Rapides', 'Vernon', 'Natchitoches', 'Beauregard', 'Allen', 'Sabine', 'Grant', 'Concordia', 'LaSalle', 'Catahoula', 'De Soto', 'Plaquemines']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'LA', "county_name": {"$in": i}})
