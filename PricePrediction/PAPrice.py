...
# Regions from: http://www.pavisitorsnetwork.com/pastatemap/

Region1 = ['Erie', 'Crawford', 'Mercer', 'Venango']
Region2 = ["Elk", "Warren",  "McKean",  "McKean", "Potter","Potter",  "Clinton", "Lycoming","Clearfield","Cameron","Clarion", "Jefferson"]
Region3 = ["Bedford", "Carbon", "Luzerne", "Monroe", "Pike", "Lackawanna", "Susquehanna","Sullivan", "Wayne", "Schuylkill", "Wyoming"]
Region4 = ["Allegheny", "Armstrong", "Beaver", "Butler", "Fayette", "Greene", "Indiana", "Lawrence", "Somerset",
           "Washington", "Westmoreland"]
Region5 = ["Columbia", "Montour", "Northumberland", "Snyder", "Union"]
Region6 = ["Blair", "Bradford", "Cambria", "Centre", "Fulton", "Huntingdon", "Juniata", "Mifflin"]
Region7 = ["Adams", "Berks", "Cumberland", "Dauphin", "Franklin", "Lancaster", "Lebanon", "Perry", "York"]
Region8 = ["Bucks", "Chester", "Delaware", "Lehigh", "Montgomery", "Northampton", "Philadelphia"]

Region = [Region1, Region2, Region3, Region4, Region5, Region6, Region7, Region8]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'PA', "county_name": {"$in": i}})
