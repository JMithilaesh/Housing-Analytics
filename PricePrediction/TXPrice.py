...
# Regions from: https://comptroller.texas.gov/economy/economic-data/regions/
Region1 = ['Atascosa', 'Bandera', 'Bexar', 'Calhoun', 'Comal', 'Dewitt', 'Frio', 'Gillespie', 'Goliad', 'Gonzales',
           'Guadalupe', 'Jackson', 'Karnes', 'Kendall', 'Kerr', 'Lavaca', 'Medina', 'Victoria', 'Wilson']

Region2 = ['Bastrop', 'Blanco', 'Burnet', 'Caldwell', 'Fayette', 'Hays', 'Lee', 'Llano', 'Travis', 'Williamson']

Region3 = ['Bell', 'Bosque', 'Brazos', 'Burleson', 'Coryell', 'Falls', 'Freestone', 'Grimes', 'Hamilton', 'Hill',
           'Lampasas', 'Leon', 'Limestone', 'Madison', 'Mclennan', 'Milam', 'Mills', 'Robertson', 'San', 'Saba',
           'Washington']

Region4 = ['Austin', 'Brazoria', 'Chambers', 'Colorado', 'Fort', 'Bend', 'Galveston', 'Harris', 'Liberty', 'Matagorda',
           'Montgomery', 'Walker', 'Waller', 'Wharton']

Region5 = ['Armstrong', 'Bailey', 'Briscoe', 'Carson', 'Castro', 'Childress', 'Cochran', 'Collingsworth', 'Crosby',
...
Region6 = ['Collin', 'Cooke', 'Dallas', 'Denton', 'Ellis', 'Erath', 'Fannin', 'Grayson', 'Hood', 'Hunt', 'Johnson',
           'Kaufman', 'Navarro', 'Palo', 'Pinto', 'Parker', 'Rockwall', 'Somervell', 'Tarrant', 'Wise']

Region7 = ['Archer', 'Baylor', 'Brown', 'Callahan', 'Clay', 'Coleman', 'Comanche', 'Cottle', 'Eastland', 'Fisher',
           ...
           'Reagan', 'Reeves', 'Schleicher', 'Sterling', 'Sutton', 'Terrell', 'Tom', 'Green', 'Upton', 'Ward',
           'Winkler']

Region8 = ['Angelina', 'Hardin', 'Houston', 'Jasper', 'Jefferson', 'Nacogdoches', 'Newton', 'Orange', 'Polk', 'Sabine',
           'San', 'Augustine', 'San', 'Jacinto', 'Shelby', 'Trinity', 'Tyler',
           'Anderson', 'Bowie', 'Camp', 'Cass', 'Cherokee', 'Delta', 'Franklin', 'Gregg', 'Harrison', 'Henderson',
           'Hopkins', 'Lamar', 'Marion', 'Morris', 'Panola', 'Rains', 'Red', 'River', 'Rusk', 'Smith', 'Titus',
           'Upshur', 'Van', 'Zandt', 'Wood']

Region9 = ['Aransas', 'Bee', 'Brooks', 'Cameron', 'Dimmit', 'Duval', 'Edwards', 'Hidalgo', 'Jim', 'Hogg', 'Jim',
           'Wells', 'Kenedy', 'Kinney', 'Kleberg', 'La', 'Salle', 'Live', 'Oak', 'Maverick', 'McMullen', 'Nueces',
           'Real', 'Refugio', 'San', 'Patricio', 'Starr', 'Uvalde', 'Val', 'Verde', 'Webb', 'Willacy', 'Zapata',
           'Zavala',
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'TX', "county_name": {"$in": i}})
