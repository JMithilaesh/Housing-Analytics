...
# Regions from: https://charlestonandlowcountry.com/sc-regions

Region1 = ['harleston', 'Berkley', 'Dorchester', 'Colleton', 'Beaufort', 'Jasper', 'Hampton', 'Allendale', 'Bamberg', 'Orangeburg', 'Calhoun']
Region2 = ['Georgetown', 'Horry', 'Williamsburg', 'Florence', 'Marion', 'Dillon', 'Clarendon', 'Sumter', 'Lee', 'Darlington', 'Marlboro', 'Chesterfield']
Region3 = ['Richland', 'Lexington', 'Newberry', 'Fairfield', 'Kershaw', 'Lancaster', 'Chester', 'York', 'Edgefield', 'Aiken', 'Barnwell']
Region4 = ['Greenville', 'Spartanburg', 'Cherokee', 'Union', 'Laurens', 'Pickens', 'Oconee', 'Anderson', 'Abbeville', 'Greenwood', 'McCormick']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'SC', "county_name": {"$in": i}})
