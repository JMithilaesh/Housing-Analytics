...
# Regions from: https://census.ca.gov/regions/
Region1 = ['Butte', 'Colusa', 'El Dorado', 'Glenn', 'Lassen', 'Modoc', 'Nevada', 'Placer',
    'Plumas', 'Sacramento', 'Shasta', 'Sierra', 'Siskiyou', 'Sutter', 'Tehama', 'Yolo', 'Yuba']
Region2 = ['Del Norte', 'Humboldt', 'Lake', 'Mendocino', 'Napa', 'Sonoma', 'Trinity']
Region3 = ['Alameda', 'Contra Costa', 'Marin', 'San Francisco', 'San Mateo', 'Santa Clara', 'Solano']
Region4 = ['Alpine', 'Amador', 'Calaveras', 'Madera', 'Mariposa', 'Merced', 'Mono', 'San Joaquin', 'Stanislaus', 'Tuolumne']
Region5 = ['Monterey', 'San Benito', 'San Luis Obispo', 'Santa Barbara', 'Santa Cruz', 'Ventura']
Region6 = ['Fresno', 'Inyo', 'Kern', 'Kings', 'Tulare']
Region7 = ['Riverside','San Bernardino']
Region8 = ['Los Angeles']
Region9 = ['Orange']
Region10 = ['Imperial', 'San Diego']

Region = [Region1, Region2, Region3, Region4, Region5, Region6, Region7, Region8, Region9, Region10]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'CA', "county_name": {"$in": i}})
