...
# Regions from: https://sonmrr.org/information/sonm_areas.html

Region1 = ['San Juan', 'Cibola', 'McKinley']
Region2 = ['Bernalillo', 'Sandoval', 'Socorro', 'Valencia', 'Torrance']
Region3 = ['Santa Fe', 'Los Alamos', 'Taos', 'Mora', 'Colfax', 'Union', 'Harding', 'San Miguel', 'Rio Arriba', 'Guadalupe']
Region4 = ['Dona Ana', 'Luna', 'Hidalgo', 'Grant', 'Catron', 'Otero', 'Sierra']
Region5 = ['Eddy', 'Lea', 'Lincoln', 'Chaves', 'Roosevelt', 'Curry', 'DeBaca', 'Quay']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'NM', "county_name": {"$in": i}})
