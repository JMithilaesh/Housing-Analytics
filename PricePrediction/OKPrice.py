...
# Regions from: https://www.okhistory.org/shpo/wpa.htm

Region1 = ['Beaver', 'Cimarron', 'Texas', 'Alfalfa', 'Ellis', 'Garfield', 'Grant', 'Harper', 'Kay', 'Major', 'Noble', 'Woods', 'Woodward']
Region2 = ['Adair', 'Cherokee', 'Craig', 'Creek', 'Delaware', 'Mayes', 'McIntosh', 'Muskogee', 'Nowata', 'Okfuskee', 'Okmulgee', 'Osage', 'Ottawa', 'Pawnee', 'Rogers', 'Sequoyah', 'Tulsa', 'Wagoner', 'Washington']
Region3 = ['Atoka', 'Bryan', 'Choctaw', 'Coal', 'Haskell', 'Hughes', 'Latimer', 'Le Flore', 'McCurtain', 'Pittsburg', 'Pushmataha']
Region4 = ['Carter', 'Garvin', 'Johnston', 'Love', 'Marshall', 'McClain', 'Murray', 'Pontotoc', 'Pottawatomie', 'Seminole']
Region5 = ['Canadian', 'Cleveland', 'Kingfisher', 'Lincoln', 'Logan', 'Oklahoma', 'Payne',
           'Beckham,', 'Blaine,', 'Caddo,', 'Comanche,', 'Cotton,', 'Custer,', 'Dewey,', 'Grady,', 'Greer,', 'Harmon,', 'Jackson,', 'Jefferson,', 'Kiowa,', 'Roger', 'Mills,', 'Stephens,', 'Tillman,', 'Washita']

Region = [Region1, Region2, Region3, Region4, Region5]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'OK', "county_name": {"$in": i}})
