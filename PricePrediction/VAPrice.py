...
# Regions from: https://www.vaco.org/county-profiles/vaco-regions/
Region1 = ['Accomack', 'Isle of Wight', 'Northampton', 'Prince George', 'Southampton', 'Surry', 'Sussex',
           'Essex', 'Gloucester', 'James City', 'King and Queen', 'King William', 'Lancaster', 'Mathews', 'Middlesex',
           'Northumberland', 'Richmond', 'Westmoreland', 'York', 'Virginia Beach','King George','Chesapeake', 'Suffolk',
           'Norfolk', 'Newport News', 'Poquoson', 'Hampton', 'Portsmouth', 'Petersburg', 'Salem']

Region2 = ['Arlington', 'Fairfax', 'Loudoun', 'Prince William','Manassas','Falls Church','Alexandria','Winchester']

Region3 = ['Charles City', 'Chesterfield', 'Hanover', 'Henrico', 'New Kent',
           'Albemarle', 'Buckingham', 'Cumberland', 'Fluvanna', 'Powhatan', 'Nelson',
           'Caroline', 'Culpeper', 'Fauquier', 'Louisa', 'Orange', 'Rappahannock', 'Spotsylvania', 'Stafford',
           'Amelia', 'Brunswick', 'Charlotte', 'Dinwiddie', 'Greensville', 'Lunenburg', 'Mecklenburg', 'Nottoway',
           'Prince Edward','Fredericksburg', 'Charlottesville', 'Goochland']

Region4 = ['Clarke', 'Frederick', 'Greene', 'Madison', 'Page', 'Shenandoah', 'Warren','Waynesboro']

Region5 = ['Alleghany', 'Amherst', 'Augusta', 'Bath', 'Highland', 'Rockbridge', 'Rockingham', 'Harrisonburg',
           'Appomattox', 'Campbell', 'Floyd', 'Franklin', 'Halifax', 'Henry', 'Mongomery', 'Patrick', 'Pittsylvania',
           'Bedford', 'Botetourt', 'Craig', 'Giles', 'Roanoke',
           'Bland', 'Carroll', 'Grayson', 'Pulaski', 'Smyth', 'Washington', 'Wythe', 'Danville',
           'Buchanan', 'Dickenson', 'Lee', 'Russell', 'Scott', 'Tazewell', 'Wise', 'Montgomery', 'Staunton', 'Lynchburg']

Region = [Region1, Region2, Region3, Region4, Region5]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'VA', "county_name": {"$in": i}})
