...
# Regions from: https://www2.illinois.gov/epa/about-us/Locations/Pages/regional-offices.aspx#region-1

Region1 = ['Boone', 'Carroll', 'DeKalb', 'JoDaviess', 'LaSalle', 'Lee', 'Ogle', 'Putnam', 'Stephenson', 'Whiteside', 'Winnebago']
Region2 = ['Cook', 'DuPage', 'Grundy', 'Kane', 'Kankakee', 'Kendall', 'Lake', 'McHenry', 'Will']
Region3 = ['Fulton', 'Hancock', 'Henderson', 'Henry', 'Knox', 'McDonough', 'Marshall', 'Mercer', 'Peoria', 'Rock Island', 'Stark', 'Tazewell', 'Warren', 'Woodford']
Region4 = ['Champaign', 'Clark', 'Coles', 'Crawford', 'Cumberland', 'DeWitt', 'Douglas', 'Edgar', 'Effingham', 'Ford', 'Iroquois', 'Jasper', 'Livingston', 'McLean', 'Macon', 'Moultrie', 'Piatt', 'Shelby', 'Vermilion']
Region5 = ['Adams', 'Brown', 'Calhoun', 'Cass', 'Christian', 'Greene', 'Jersey', 'Logan', 'Macoupin', 'Mason', 'Menard', 'Montgomery', 'Morgan', 'Pike', 'Sangamon', 'Schuyler', 'Scott']
Region6 = ['Bond', 'Clinton', 'Fayette', 'Madison', 'Marion', 'Monroe', 'Randolph', 'St. Clair', 'Washington']
Region7 = ['Alexander', 'Clay', 'Edwards', 'Franklin', 'Gallatin', 'Hamilton', 'Hardin', 'Jackson', 'Jefferson', 'Johnson', 'Lawrence', 'Massac', 'Perry', 'Pope', 'Pulaski', 'Richland', 'Saline', 'Union', 'Wabash', 'Wayne', 'White', 'Williamson']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'IL', "county_name": {"$in": i}})
