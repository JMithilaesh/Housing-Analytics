...
# Regions from: https://www.dot.ny.gov/regional-offices
Region1 = ['Albany', 'Essex', 'Greene', 'Rensselaer', 'Saratoga', 'Schenectady', 'Warren', 'Washington',
'Hamilton', 'Herkimer', 'Fulton', 'Madison', 'Montgomery', 'Oneida',
 'Clinton', 'Franklin', 'Jefferson', 'Lewis', 'St. Lawrence']
Region2 = ['Columbia', 'Dutchess', 'Orange', 'Putnam', 'Rockland', 'Ulster', 'Westchester']
Region3 = ['Cayuga', 'Cortland', 'Onondaga', 'Oswego', 'Seneca', 'Tompkins']
Region4 = [ 'Monroe', 'Ontario', 'Livingston', 'Orleans', 'Genesee', 'Wyoming', 'Wayne',
 'Allegany', 'Chemung', 'Schuyler', 'Steuben', 'Yates']
Region5 = ['Cattaraugus', 'Chautauqua', 'Erie', 'Niagara']
Region6 = ['Nassau','Suffolk']
Region7 = ['Bronx', 'Kings', 'New', 'York', 'Queens', 'Richmond']

Region = [Region1, Region2, Region3, Region4, Region5, Region6, Region7]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'NY', "county_name": {"$in": i}})
