...
# Regions from: http://ccionline.org/cci/district-officers/

Region1 = ['Cheyenne', 'Elbert', 'Kit Carson', 'Lincoln', 'Logan', 'Morgan', 'Phillips', 'Sedgwick', 'Washington', 'Yuma',
           'Alamosa', 'Baca', 'Bent', 'Conejos', 'Costilla', 'Crowley', 'Huerfano', 'Kiowa', 'Las Animas', 'Mineral', 'Otero', 'Prowers', 'Pueblo', 'Rio Grande', 'Saguache']

Region2 = ['Adams', 'Arapahoe', 'Boulder', 'Broomfield', 'Denver', 'Douglas', 'El Paso', 'Jefferson', 'Larimer', 'Weld']

Region3 = ['Chaffee', 'Clear Creek', 'Custer', 'Eagle', 'Fremont', 'Gilpin', 'Grand', 'Jackson', 'Lake', 'Park', 'Pitkin', 'Summit', 'Teller']


Region5 = ['Archuleta', 'Delta', 'Dolores', 'Garfield', 'Gunnison', 'Hinsdale', 'La Plata', 'Mesa', 'Moffat', 'Montezuma', 'Montrose', 'Ouray', 'Rio Blanco', 'Routt', 'San Juan', 'San Miguel']


Region = [Region1, Region2, Region3, Region5]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'CO', "county_name": {"$in": i}})
