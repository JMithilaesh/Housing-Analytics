...
# Regions from: https://www.utd.uscourts.gov/district-utah-map

Region1 = ['Box Elder', 'Cache', 'Davis', 'Morgan', 'Rich', 'Weber']
Region2 = ['Carbon', 'Daggett', 'Duchesne', 'Juab', 'Salt Lake', 'Summit', 'Tooele', 'Uintah', 'Utah', 'Wasatch']
Region3 = ['Beaver', 'Emery', 'Garfield', 'Grand', 'Iron', 'Kane', 'Millard', 'Piute', 'San Juan', 'Sanpete', 'Sevier', 'Washington', 'Wayne']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'UT', "county_name": {"$in": i}})
