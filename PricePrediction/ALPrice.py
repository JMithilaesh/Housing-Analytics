...
# Regions from: https://alabama200.org/uploads/files/PastPort_Region_Guide.pdf
...
Region3 = ['Chambers', 'Clay', 'Cleburne', 'Coosa', 'Elmore', 'Lee', 'Randolph', 'Tallapoosa']

Region4 = ['Blount', 'Calhoun', 'Cherokee', 'Cullman', 'Etowah', 'Jefferson', "St. Clair", 'Shelby', 'Talladega', 'Walker', 'Winston']

Region5 = ['Bullock', 'Dallas', 'Greene', 'Hale', 'Lowndes', 'Macon', 'Marengo', 'Montgomery', 'Perry', 'Russell', 'Sumter', 'Wilcox']

Region6 = ['Autauga', 'Bibb', 'Chilton', 'Fayette', 'Lamar', 'Marion', 'Pickens', 'Tuscaloosa']

Region7 = ['Baldwin', 'Butler', 'Choctaw', 'Clarke', 'Conecuh', 'Escambia', 'Mobile', 'Monroe', 'Washington']

Region = [Region1, Region2, Region3, Region4, Region5, Region6, Region7]

for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'AL', "county_name": {"$in": i}})
