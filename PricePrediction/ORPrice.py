...
# Regions from: https://www.oregonpainguidance.org/regions/

Region1 = ['Baker', 'Union', 'Malheur', 'Umatilla', 'Deschutes', 'Crook', 'Jefferson']
Region2 = ['Clatsop', 'Tillamook', 'Columbia']
Region3 = ['Josephine', 'Jackson', 'Klamath', 'Lake', 'Coos', 'Curry']
Region4 = ['Lane', 'Douglas']
Region5 = ['Lincoln', 'Linn', 'Benton']
Region6 = ['Marion', 'Yamhill', 'Polk', 'Clackamas', 'Multnomah', 'Washington']
Region7 = ['Gilliam', 'Grant', 'Harney', 'Hood River', 'Modoc', 'Morrow', 'Sherman', 'Wallowa', 'Wasco', 'Wheeler']
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'OR', "county_name": {"$in": i}})
