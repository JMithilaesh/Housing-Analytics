...
# Regions from: https://www.tn.gov/tdot/about/county-outline-map.html

Region1 = ["Anderson", "Blount", "Campbell", "Carter", "Claiborne", "Cocke","Grainger","Greene","Hamblen","Hancock","Hawkins","Jefferson","Johnson","Knox", "Loudon","Monroe","Morgan","Roane","Scott","Sevier","Sullivan","Unicoi","Union","Washington"]
Region2 = ["Bledsoe", "Bradley", "Cannon", "Clay","Coffee", "Cumberland","Decatur","Fentress", "Franklin","Grundy","Hamilton","Jackson","McMinn","Marion","Meigs","Overton","Pickett","Polk","Putnam","Rhea","Sequatchie","Van Buren","Weakley"]
Region3 = ["Bedford", "Cheatham","Davidson", "Dickson","Giles","Hickman","Houston","Humphreys","Lawrence","Lewis","Lincoln", "Macon","Marshall","Maury","Montgomery","Moore","Perry","Robertson","Rutherford","Smith","Stewart","Sumner","Trousdale","Warren","Wayne","Williamson","Wilson"]
Region4 = ["Benton", "Carroll", "Chester", "Crockett","DeKalb","Dyer","Fayette","Gibson","Hardeman","Hardin","Haywood","Henderson","Henry","Lake","Lauderdale","McNairy","Madison","Obion","Shelby","Tipton","Weakley"]
...
for i in Region:
    print('For ' + str(i) + '#################################################################')
    R1_Zip = db[colZip].distinct("zip", {'state_id': 'TN', "county_name": {"$in": i}})
